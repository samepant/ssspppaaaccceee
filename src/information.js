      ...
      <div className='info-container'>
        <div className='info'>
          ...
          <article className='columns'>
            <p><a href='https://www.indiegogo.com/projects/space-space-space-conference-art-education#/' target='_blank'>Support us on Indiegogo!</a></p>
        ...
        <div className='info'>
          ...
          <article className='flex-3'>
            <div className='workshop'>
              <p className='time'>Thursday 2 pm</p>
              ...
              <p className='register'><a href='https://www.eventbrite.com/e/space3-tower-and-dungeon-school-stadium-tickets-43584567615?aff=es2' target='_blank'>REGISTER HERE</a></p>
            </div>
            <div className='workshop'>
